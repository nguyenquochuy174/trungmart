...
import { listNotificationAdmin } from '~/constant/mock-data';
...
function Notification() {
    ...
    const idAd = useMemo(() => parseInt(localStorage.getItem('idAd')), []);

    useEffect(() => {
        const userNotifications = listNotificationAdmin.filter(
            (item) => item.receiverId === idAd,
        );
